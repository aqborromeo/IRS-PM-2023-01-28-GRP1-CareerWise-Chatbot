...
class ChatSessionsApi(Resource):
    ...
    def post(token_data, self):
        ...
        intro_chat_parameter = {
            ...
            'message_text': 'Welcome to the myUpskill Chat Bot! We can identify careers that best suit your aspirations. All you need to do is answer a few simple questions. Shall we begin?',
